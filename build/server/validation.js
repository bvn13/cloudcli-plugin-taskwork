...
export function requireId(value, field) {
    if (!isValidId(value))
        throw new ValidationError(`${field} must match [A-Za-z0-9_-]+`);
    return value;
}
...
export function requireTitle(raw) {
